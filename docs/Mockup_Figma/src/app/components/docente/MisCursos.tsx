...
export function MisCursos() {
  ...
  return (
    <>
      <PageHeader title="Portal Docente — Mis Cursos" />
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ display: "flex", gap: "16px", fontSize: "12px", color: "#6b7280" }}>
                <span style={{ display: "flex", alignItems: "center", gap: "4px" }}>
                  <Calendar size={11} /> Cohorte {curso.cohorte} · {curso.cuatrimestre}
                </span>
                <span style={{ display: "flex", alignItems: "center", gap: "4px" }}>
                  <Users size={11} /> {curso.estudiantes} estudiantes
                </span>
          ...
          {otrosCursos.map((curso, i) => (
            ...
            >
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ display: "flex", gap: "12px", fontSize: "11px", color: "#6b7280" }}>
                  <span style={{ display: "flex", alignItems: "center", gap: "3px" }}>
                    <Calendar size={10} /> Cohorte {curso.cohorte} · {curso.cuatrimestre}
                  </span>
                  {curso.estudiantes && (
                    <span style={{ display: "flex", alignItems: "center", gap: "3px" }}>
                      <Users size={10} /> {curso.estudiantes} estudiantes
                    </span>
                  )}
                  <EstadoBadge estado={curso.estado} />
                </div>
              ...
              {curso.estado === "Finalizado" && (
                ...
                >
                  Ver actas <ChevronRight size={12} />
                </button>
              )}
            </div>
          ))}
